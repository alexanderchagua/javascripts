...
function subtractNumbers(){
    ...
    let result2 = subtract(minuend, subtrahend);
    document.querySelector('#difference').value = result2;
}
...
function multiplyNumbers(){
    ...
    let result3 = multiply(factor1, factor2);
    document.querySelector('#product').value = result3;
}
...
function divideNumbers(){
    ...
    let result4 = divide(dividend, divisor);
    document.querySelector('#quotient').value = result4;
}
...
document.getElementById("sumOfArray").innerHTML = array.reduce(mySum, 0);
...
document.getElementById("sumOfMultiplied").innerHTML= array.map(myFunction).reduce(mySum);